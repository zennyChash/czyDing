...
import com.ifugle.utils.TripleDES;
...
public class SecureUtils {
    ...
    public static String encryptPortal(String str2Encrypt) throws Exception {
        try {
        	String key = "BEF7CEE2A38C0361";
            String iv = "851DA88265154078";
          Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
          int blockSize = cipher.getBlockSize();
          byte[] dataBytes = str2Encrypt.getBytes();
      ...
      public static String decryptPortal(String cipherText) throws Exception {
        try
        {
        	String key = "BEF7CEE2A38C0361";
            String iv = "851DA88265154078";
            //byte[] encrypted1 = new sun.misc.BASE64Decoder().decodeBuffer(cipherText);
            byte[] encrypted1 = Base64.getDecoder().decode(cipherText.getBytes());
            Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
            SecretKeySpec keyspec = new SecretKeySpec(key.getBytes(), "AES");
            IvParameterSpec ivspec = new IvParameterSpec(iv.getBytes());
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            j1.put("accountId", "123456");
            j1.put("name", "王晓慧");
            j1.put("mobile", "13867463716");
            j1.put("employeeCode", "GE_e32f017094024d8ea5eb1630a5684abc");
            j1.put("appToken", "99888fsdgsdg");
            String estr = encryptPortal(j1.toString());
            System.out.println("加密："+estr);
            
            String dcip =decryptPortal(estr); 
            System.out.println("解密："+dcip);
            JSONObject deco = new JSONObject(dcip);
            System.out.println("解密OBJECT:"+deco.toString());
        }
        catch (Exception e) {
